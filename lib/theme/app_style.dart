...
class AppStyle {
  ...
  static TextStyle txtPoppinsRegular14Black900a9 = TextStyle(
    color: ColorConstant.black900A9,
    fontSize: getFontSize(
      14,
    ),
    fontFamily: 'Poppins',
  ...
  static TextStyle txtPoppinsRegular14LightblueA200 = TextStyle(
  ...
  static TextStyle txtPoppinsRegular12Black90087 = TextStyle(
  ...
  static TextStyle txtPlantagenetCherokee32 = TextStyle(
    color: ColorConstant.gray900,
    fontSize: getFontSize(
      32,
    ),
  ...
  static TextStyle txtPoppinsRegular14Gray40001 = TextStyle(
  ...
  static TextStyle txtPoppinsMedium14Gray90087 = TextStyle(
    color: ColorConstant.gray90087,
    fontSize: getFontSize(
      14,
    ),
